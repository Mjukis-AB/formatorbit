...
### Fixed
- **CI: pyo3 build on Python 3.14** - set `PYO3_USE_ABI3_FORWARD_COMPATIBILITY` for stable ABI
- **cargo publish: bundled plugins path** - moved plugins into core crate directory
